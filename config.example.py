...
class Config:
    ...
    # Replace with your actual API keys from Alpaca Markets
    ...
    def validate(cls):
        ...
        if not cls.ALPACA_API_KEY or cls.ALPACA_API_KEY == 'YOUR_API_KEY_HERE':
            raise ValueError("Please set your Alpaca API key in config.py or environment variables")
        
        if not cls.ALPACA_SECRET_KEY or cls.ALPACA_SECRET_KEY == 'YOUR_SECRET_KEY_HERE':
            raise ValueError("Please set your Alpaca secret key in config.py or environment variables")
